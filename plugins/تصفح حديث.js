...
let handler = async (message, { conn, text, usedPrefix, command }) => {
  if (!text) {
    return conn.reply(message.chat, "[💫] *عن ماذا تريد البحث؟*", message);
  }
  ...
  let selectedImages = imageUrls.splice(0, 200);
  let imageCount = 1;
  ...
  for (let imageUrl of selectedImages) {
    results.push({
      ...
      'footer': proto.Message.InteractiveMessage.Footer.fromObject({
        'text': "BY MAIKY " // ضع العلامة المائية هنا
      }),
      ...
      'nativeFlowMessage': proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
        'buttons': [{
          'name': "cta_url",
          'buttonParamsJson': "{\"display_text\":\"「⛈️ ╎قناة البوت╎⛈️ 」\",\"Url\":\"https://www.whatsapp.com/channel/0029Vafd5a23wtbEqjlnbw1l" + text + "\",\"merchant_url\":\"https://www.whatsapp.com/channel/0029Vafd5a23wtbEqjlnbw1l" + text + "\"}",  
        }]
      })
    });
  }
