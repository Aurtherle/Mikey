...
let prekey = []
let directorio = readdirSync("./SHADOWBOT-MD")
...
const directories = ['./SHADOWBOT-MD/', './jadibts/']
...
if (reason == 405) {
await fs.unlinkSync("./SHADOWBOT-MD/" + "creds.json")
...
setInterval(async () => {
  ...
  const bio = `البوت شغال بواسطه شادو :\n\n ${uptime}`;
