     ...
     if (chat.welcome) {
              ...
              for (let user of participants) {
                ...
                try {
                  ...
                  pp = 'https://telegra.ph/file/0585e66d6c6af709b1cae.jpg'; // Assign default image URL
                  ppgp = 'https://telegra.ph/file/0585e66d6c6af709b1cae.jpg'; // Assign default image URL
                } finally {
...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: tradutor.texto11[0], body: tradutor.texto11[1], thumbnail: imagen1, sourceUrl:'https://www.atom.bio/maiky-bot////#' } } } }, aa);
